    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <div style={{ width: 64, height: 64, borderRadius: 16, background: "#16324f", display: "flex", alignItems: "flex-end", padding: 10 }}>
            <div style={{ width: 44, height: 8, borderRadius: 3, background: "#7fd1ad" }} />
          </div>
